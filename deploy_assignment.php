...
try {
    ...
    // Fetch teacher's sections with course info in active semester
    $stmt = $pdo->prepare("
...
<head>
    ...
    <style>
        ...
        .top-navbar {
            position: fixed; top: 0; left: 0; right: 0; height: auto; min-height: 64px; z-index: 900;
...
<div class="page-wrap">
    ...
    <div class="deploy-card">
        <form method="POST" action="deploy_assignment.php" enctype="multipart/form-data" id="deployForm" onsubmit="return confirm('Are you sure you want to deploy this assignment?');">
