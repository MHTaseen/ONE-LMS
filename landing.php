                    ...
                    <?php else: ?>
                        <?php foreach($recentNotifications as $n): ?>
                            <div class="notif-item <?= $n['is_read'] ? '' : 'unread' ?>" id="notif_<?= $n['id'] ?>" style="position:relative; padding-right:32px;">
                                ...
                                <button onclick="deleteNotif(event, <?= $n['id'] ?>)" style="position:absolute; right:12px; top:12px; background:none; border:none; color:var(--text-secondary); cursor:pointer;">✕</button>
                            </div>
                        <?php endforeach; ?>
